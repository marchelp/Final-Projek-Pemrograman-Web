...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@200;400;500;600;800&display=swap"
        rel="stylesheet">
                ...
                <ul class="navbar-nav p-auto ms-auto me-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="profileStrukturOrganisasi.php">Struktur Organisasi</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
